...
Subject: RocksDBStore::rm_range_keys() misses keys Put earlier in the same batch; omap_rmkeyrange leaves stale keys
...
h3. Observed (origin/main 8e6a13e7a9a; memstore @[ OK ]@ for all four)
...
* "test.cc":https://github.com/cephtools/tools/tree/main/trackers/bluestore-2026-09/04-kv-rm-range-ignores-same-txn-writes/test.cc
