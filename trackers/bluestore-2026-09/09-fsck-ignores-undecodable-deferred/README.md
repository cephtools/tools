...
| Real-world | **Real tools**: OSD created by `ceph-osd --mkfs`, then `ceph-bluestore-tool fsck/repair` and `ceph-objectstore-tool`; the corrupt record is injected with `ceph-kvstore-tool` (tracker 49847 is a field report of this state) |
