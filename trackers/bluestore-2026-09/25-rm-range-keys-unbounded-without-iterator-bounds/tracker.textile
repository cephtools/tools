...
Subject: RocksDBStore: with osd_rocksdb_iterator_bounds_enabled=false, rm_range_keys on a sharded column family ignores the range end and deletes other objects' omap
...
h3. Observed (origin/main 8e6a13e7a9a, live OSD)
...
* "live-osd-repro.sh":https://github.com/cephtools/tools/tree/main/trackers/bluestore-2026-09/25-rm-range-keys-unbounded-without-iterator-bounds/live-osd-repro.sh
