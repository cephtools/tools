...
Subject: bluefs_alloc_size / bluefs_shared_alloc_size that are not a power of 2 are accepted, then abort in the allocator
...
* "repro.sh":https://github.com/cephtools/tools/tree/main/trackers/bluestore-2026-09/23-bluefs-alloc-size-non-pow2-abort/repro.sh
