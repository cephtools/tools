...
Subject: bluestore: max_bytes_for_level_multiplier < 1 hangs OSD mkfs/mount in RocksDBBlueFSVolumeSelector
...
* "repro.sh":https://github.com/cephtools/tools/tree/main/trackers/bluestore-2026-09/11-vselector-level-multiplier-hang/repro.sh
